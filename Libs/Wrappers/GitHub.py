...
def get_repos(username:str, just_repos:bool=True):
    ...
    while True:
        try:
            ...
            res = do_get(f"/users/{username}/repos", params=params)
...
def get_issues(username:str):
    ...
    while True:
        try:
            ...
            res = do_get(f"/search/issues", params=params)
...
def get_event_emails(username: str):
    ...
    while True:
        try:
            ...
            res = do_get(f"/users/{username}/events", params=params)
...
def get_emails(repo:str, username:str=None):
    ...
    while True:
        ...
        try:
            res = do_get(f"/repos/{repo}/commits", params=params)
